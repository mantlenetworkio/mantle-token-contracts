...
describe("L1MantleToken", () => {
  ...
  beforeEach(async () => {
    ...
    const tokenFactory = new L1MantleToken__factory(deployer);
  ...
  //     const tokenInstance = new L1MantleToken__factory(deployer).attach(tokenAddress);
  ...
  //     const deployerInstance = new L1MantleToken__factory(deployer).attach(tokenAddress);
  //     const toMint = ethers.utils.parseEther("1");

  //     await deployerInstance.mint(sender.address, toMint);
  //     expect(await deployerInstance.balanceOf(sender.address)).to.eq(toMint);

  //     const senderInstance = new L1MantleToken__factory(sender).attach(tokenAddress);
